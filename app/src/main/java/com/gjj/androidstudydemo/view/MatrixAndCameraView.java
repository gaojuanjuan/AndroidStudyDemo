...
/**
 * Created by gaojuanjuan on 2018/1/22.
 */
...
public class MatrixAndCameraView extends ViewGroup {
    ...
    public MatrixAndCameraView(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public MatrixAndCameraView(Context context, AttributeSet attrs, int defStyleAttr) {
